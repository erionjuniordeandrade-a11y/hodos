...
const motor=lesson('motor-cst','Central region & descending motor pathways',20,
  ...
  step('Find the two banks of the central sulcus',
    ...
    'A lesion approaches the central sulcus from anteriorly. Which cortical bank is encountered first, and how would your anatomical emphasis change for a lesion approaching from posteriorly?',
    'Anteriorly, the precentral bank brings the primary motor relationship into focus. Posteriorly, the postcentral bank brings the somatosensory relationship into focus. In either case, extend the account into the underlying white matter. The surface relationship helps frame the examination; it does not by itself predict the deficit.',
    ['R1','M1'],{regions:cortex(8,9,54),surface:.92},{regions:['motorParcels','atlasProvenance'],targets:[parcel(8,'4 · precentral'),parcel(9,'3b · postcentral'),parcel(54,'6d · premotor')]}),
  step('Continue onto the medial motor surface',
    ...
    ['R1','M1','M9'],{regions:cortex(55,44,43,8),camera:{view:'medial',tweenMs:650},surface:.92},{regions:['motorParcels'],targets:[parcel(55,'6mp · posterior medial premotor'),parcel(44,'6ma · anterior medial premotor'),parcel(43,'SCEF · supplementary/cingulate'),parcel(8,'4 · motor reference')]}),
  step('Follow the fan into a descending corridor',
    ...
    ['M4','R2','D2'],{bundles:['CST'],regions:cortex(8),surface:.22},{regions:['cstCandidate','coronaCapsule'],evidenceClass:'reconstruction',targets:[bundle('CST','Corticospinal pathway'),parcel(8,'4 · cortical reference')]}),
  step('Motor-related origins extend beyond area 4',
    ...
    ['M4','M1'],{ghost:['CST'],regions:cortex(8,54,9),surface:.72},{regions:['cstCandidate','motorParcels'],evidenceClass:'reconstruction',targets:[parcel(8,'4'),parcel(54,'6d'),parcel(9,'3b')]}),
  step('Read the posterior limb by its neighbours',
    ...
    ['R2','M5','R8','R10','D3'],{bundles:['CST'],ghost:['CPT_F','CBT'],deep:true,deepRegions:['THA','PUT','GP'],regions:cortex(8),surface:.08,camera:{view:'anterior',tweenMs:650}},{regions:['coronaCapsule','corticopontine','striatopallidal'],targets:[deep('THA','Thalamus'),deep('PUT','Putamen'),deep('GP','Globus pallidus'),bundle('CBT','Corticobulbar · context')]}),
  step('Distinguish anterior from posterior capsule',
    ...
    ['R2','D3'],{bundles:['CST'],ghost:['CS_A','CS_S'],deep:true,deepRegions:['CAU','THA','PUT','GP'],surface:.08,camera:{view:'anterior',tweenMs:650}},{regions:['striatopallidal'],targets:[deep('CAU','Caudate'),deep('THA','Thalamus'),deep('PUT','Putamen'),deep('GP','Pallidum')]}),
  step('Add sensory pathways to the deep region',
    ...
    ['M6','D2','D3'],{bundles:['ML','TR_S'],ghost:['CST'],deep:true,deepRegions:['THA'],regions:cortex(9,51),surface:.16},{regions:['sensoryReturn','thalamus'],evidenceClass:'reconstruction',targets:[bundle('ML','Medial lemniscus'),bundle('TR_S','Superior thalamic radiation'),deep('THA','Thalamus')]}),
  step('Distinguish cerebellar input and output routes',
    ...
    ['M8','M7','D2'],{bundles:['DRTT','SCP','MCP'],ghost:['CST'],deep:true,deepRegions:['THA'],surface:.1,camera:{view:'posterior',tweenMs:650}},{regions:['cerebellarLoop'],evidenceClass:'reconstruction',targets:[bundle('SCP','Superior cerebellar peduncle'),bundle('MCP','Middle cerebellar peduncle'),bundle('DRTT','Dentatorubrothalamic pathway')]}),
  step('Separate a motor map from a parcel map',
    ...
    ['M2','M1'],{regions:cortex(8,55),bundles:['CST'],surface:.82},{regions:['effectorMap'],evidenceClass:'functional_measurement',targets:[parcel(8,'4 · atlas boundary'),parcel(55,'6mp · medial context')]}),
  step('Explain a motor deficit at three levels',
    ...
    ['R1','R2','M9','M8','D2'],{regions:cortex(8,55,9),bundles:['CST'],ghost:['DRTT'],deep:true,deepRegions:['THA','PUT'],surface:.2},{evidenceClass:'schematic',targets:[parcel(8,'4'),parcel(55,'6mp'),deep('THA','Thalamus'),deep('PUT','Putamen')]}),
]);
...
const fat=lesson('fat-language','Frontal aslant tract & speech planning',12,
  ...
  step('Connect lateral and medial frontal references',
    ...
    ['R9','S4','R6','M1'],fatScene(),{evidenceClass:'reconstruction',targets:[parcel(74,'44 · inferior frontal'),parcel(44,'6ma · anterior medial'),parcel(55,'6mp · posterior medial')]}),
  step('Separate an association tract from a projection tract',
    ...
    ['S4','D2','M4'],fatScene({ghost:['CST']}),{evidenceClass:'reconstruction',targets:[bundle('FAT','Frontal aslant'),bundle('CST','Corticospinal context')]}),
  ...
  step('Build a task-specific anatomical explanation',
    ...
    ['R6','R7','S4','M9','R11'],fatScene(),{evidenceClass:'schematic',targets:[parcel(74,'44 · lateral reference'),parcel(44,'6ma · anterior medial'),parcel(55,'6mp · posterior medial')]}),
],{regionCards:['fat']});
...
const optic=lesson('optic-radiation','Optic radiation & the temporal stem',12,
  ...
  step('Orient the thalamic–occipital relationship',
    ...
    ['R3','R4','D3','M1'],opticScene(),{referencePlate:'optic-radiation',targets:[parcel(1,'V1 · visual cortex'),deep('THA','Gross thalamus'),bundle('OR','Optic radiation')]}),
  step('Follow the anterior turn before the posterior course',
    ...
    ['R3','R4','S6'],opticScene(),{referencePlate:'temporal-horn',evidenceClass:'reconstruction',targets:[bundle('OR','Optic radiation'),deep('HIP','Hippocampus · context')]}),
  step('Compare the temporal-stem neighbours',
    ...
    ['R3','D2'],opticScene({ghost:['UF','IFOF']}),{evidenceClass:'experimental_anatomy',targets:[bundle('OR','Optic radiation'),bundle('UF','Uncinate'),bundle('IFOF','Inferior fronto-occipital')]}),
...
const evidence=lesson('evidence-classes','What the anatomy image can establish',8,
  ...
  step('A landmark and a parcel answer different questions',
    ...
    ['M1','R1'],{regions:cortex(8,9),surface:.92},{regions:['parcels'],targets:[parcel(8,'4'),parcel(9,'3b')]}),
...
const sampling=lesson('sampling-support','Reading a sparse or incomplete tractogram',8,
  ...
  step('Line count is a sampling choice',
    ...
    ['D2','S8'],{bundles:['CST'],ghost:['OR'],surface:.12},{evidenceClass:'model_metric',targets:[bundle('CST','Corticospinal'),bundle('OR','Optic radiation')]}),
...
const insula=lesson('interoception','Insula, central core & interoception',12,
  ...
  step('Orient anterior and posterior insular regions',
    ...
    ['R5','M1'],insulaScene({regions:cortex(106,111)}),{targets:[parcel(106,'PoI2'),parcel(111,'AVI')]}),
  step('Place the lentiform complex deeper than insula',
    ...
    ['R2','R5','D3'],insulaScene({regions:cortex(106),deepRegions:['PUT','GP','THA'],ghost:['CST'],surface:.08}),{targets:[parcel(106,'PoI2 · insular reference'),deep('PUT','Putamen'),deep('GP','Pallidum'),deep('THA','Thalamus')]}),
  step('Add a functional framework without inventing a circuit',
    ...
    ['S11','S12','M1','D3'],insulaScene({regions:cortex(106,111),deepRegions:['THA']}),{regions:['body','insula','thalamus'],evidenceClass:'conceptual_model',targets:[parcel(106,'PoI2'),parcel(111,'AVI'),deep('THA','Gross thalamus')]}),
  step('Present an insular lesion in anatomical layers',
    ...
    ['R2','R5','S11','N6'],insulaScene({regions:cortex(111,106),deepRegions:['PUT','GP','THA']}),{evidenceClass:'schematic',targets:[parcel(111,'AVI'),parcel(106,'PoI2'),deep('PUT','Putamen')]}),
],{regionCards:['insula']});
