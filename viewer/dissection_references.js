...
export const DISSECTION_PLATES=Object.freeze({
  'lateral-association':{
    title:'Lateral association fibres in dissection',slide:56,sha:'7f4bb4de4cfb',width:1619,
  ...
  ifof:{
    title:'The long fronto-occipital course',slide:82,sha:'ace600b227db',width:1601,
  ...
  uncinate:{
    title:'The uncinate turn at the limen',slide:98,sha:'23e15b5dd071',width:1601,
  ...
  'optic-radiation':{
    title:'Optic radiation beside the ventricular region',slide:124,sha:'3654ed9e257d',width:1608,
  ...
  'temporal-horn':{
    title:'Temporal horn beneath the exposed fibres',slide:127,sha:'6f16a698d8f4',width:1608,
...
const photo=(id,plate)=>node('img',{src:`./reference-plates/${id}.webp?v=${plate.sha}`,alt:plate.alt,width:plate.width,height:1080,loading:'lazy',decoding:'async'});
