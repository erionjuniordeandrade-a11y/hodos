...
export const DISSECTION_PLATES=Object.freeze({
  'lateral-association':{
    title:'Lateral association fibres in dissection',slide:56,width:1619,
  ...
  ifof:{
    title:'The long fronto-occipital course',slide:82,width:1601,
  ...
  uncinate:{
    title:'The uncinate turn at the limen',slide:98,width:1601,
  ...
  'optic-radiation':{
    title:'Optic radiation beside the ventricular region',slide:124,width:1608,
  ...
  'temporal-horn':{
    title:'Temporal horn beneath the exposed fibres',slide:127,width:1608,
...
const photo=(id,plate)=>node('img',{src:`./reference-plates/${id}.png`,alt:plate.alt,width:plate.width,height:1080,loading:'lazy',decoding:'async'});
